		      	...
		      	<form action="{{ route('login') }}" class="signin-form" method="POST">
                    @csrf
		      		<div class="form-group">
                          ...
                          @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong style="color:#a12a2a">{{ $message }}</strong>
                            </span>
                          @enderror
		      		</div>
	            <div class="form-group">
	              <input id="password-field" name="password" type="password" placeholder="Password" class="form-control @error('password') is-invalid @enderror">
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong style="color:#a12a2a">{{ $message }}</strong>
                        </span>
